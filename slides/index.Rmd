...
date: "<span style = 'font-size: 90%;'>rsudioconf2020<br><br> January, 2020</span><br>`r icon::fontawesome(name = 'layer-group', 'solid')` [bit.ly/njt-rstudio](https://bit.ly/njt-rstudio)<br><br>`r icon::fontawesome$brands$twitter` [nj_tierney](https://twitter.com/nj_tierney)"
output:
...
# Can we think of longitudinal data a **time series**?
...
`r icon::fontawesome$solid$binoculars` Generalise beyond time series
