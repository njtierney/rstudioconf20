---
title: 'How to make better spaghetti (plots) `r emo::ji("spaghetti")` `r emo::ji("spaghetti")` `r emo::ji("spaghetti")`'
author: Nicholas Tierney, Monash University
date: "rsudioconf2020 <br><br> January, 2020 <br><br> `r icon::fontawesome(name = 'layer-group', 'solid')` [bit.ly/njt-rstudio](https://bit.ly/njt-rstudio) <br><br> `r icon::fontawesome$brands$twitter` [nj_tierney](https://twitter.com/nj_tierney)"
output:
...
# `r emo::ji("thinking")` Can we think of longitudinal data as a **time series**?
...
You have hit the **distraction threshold**
...
```{r print-gg-facet-strata-again-again, ref.label='gg-facet-strata'}
```
...
2. Specify structure once, get a free lunch. `r emo::ji("sandwich")`
