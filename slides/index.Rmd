...
date: "<div class='medium'>rstudioconf2020, January 29 <br><br> `r icon::fontawesome(name = 'link', 'solid')` [bit.ly/njt-rstudio](https://bit.ly/njt-rstudio) <br><br> `r icon::fontawesome$brands$twitter` [nj_tierney](https://twitter.com/nj_tierney)</div>"
output:
...
```{r steaming-sketti, out.width = "75%"}
...
```{r gg-facet-sample-all-out, ref.label = 'gg-facet-sample-all', echo = FALSE, out.width = "100%"}
```
