...
date: "<span style = 'font-size: 90%;'>rsudioconf2020<br><br> January, 2020</span><br><br> `r icon::fa('link')` [bit.ly/njt-rstudio](https://bit.ly/njt-rstudio)<br><br>`r icon::fa('twitter')` [nj_tierney](https://twitter.com/nj_tierney)"
output:
