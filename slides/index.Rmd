...
```{r noodle-explode-gif, out.width = "40%"}
include_graphics("gifs/noodle-explode.gif")
```

---

<iframe width="950" height="590" src="https://www.youtube.com/embed/UerBCXHKJ5s?start=38" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
# ~~What is longitudinal data?~~ Longitudinal data as a time series.
...
.pull-right[
"How many facets to put data into?"
...
```{r many-ggplots, eval = FALSE, echo = FALSE}
